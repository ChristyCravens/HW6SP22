...
class Fluid():
    def __init__(self, mu=0.00089, rho=1000):
        ...
        self.nu= mu/rho #$JES MISSING CODE$ # calculate the kinematic viscosity in units of m^2/s
...
class Pipe():
    ...
    def Re(self):
        ...
        :return:
        '''
        self.reynolds= (self.V()*self.length)/0.00000089 #$JES MISSING CODE$ # Re=rho*V*d/nu, be sure to use V() so velocity is updated.
